    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="max-w-3xl">
          <div className="inline-block bg-christmas-red/20 backdrop-blur-sm border border-christmas-gold/40 rounded-full px-6 py-2 mb-6 animate-fade-in">
            <span className="text-christmas-gold font-semibold text-sm flex items-center gap-2">
              🎄 Especial de Natal - Referência em Contemplações ❄️
            </span>
          </div>
          
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight animate-fade-in-up">
            Realize Seus <span className="text-christmas-gold font-christmas">Sonhos</span> com
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 mt-16 pt-16 border-t border-white/20">
            <div className="text-center sm:text-left">
              <div className="text-3xl sm:text-4xl font-bold text-christmas-gold mb-2">+5000</div>
              <div className="text-gray-300 font-medium">Clientes Atendidos</div>
            </div>
            <div className="text-center sm:text-left">
              <div className="text-3xl sm:text-4xl font-bold text-christmas-gold mb-2">98%</div>
              <div className="text-gray-300 font-medium">Satisfação</div>
            </div>
            <div className="text-center sm:text-left">
              <div className="text-3xl sm:text-4xl font-bold text-christmas-gold mb-2">+15</div>
